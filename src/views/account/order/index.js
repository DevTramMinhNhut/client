...
function Order() {
  ...
  return (
    ...
    <Nav variant="tabs" >
      <Nav.Item >
        <Nav.Link onClick={() =>setStatus()} style={{color: 'black', width:"214px"}} eventKey="link-1">Tất cả đơn hàng</Nav.Link>
      </Nav.Item>
      <Nav.Item>
        <Nav.Link  onClick={()=> setStatus('Chưa xác nhận')} style={{color: 'black', width:"214px"}}eventKey="link-2">Chờ xác nhận</Nav.Link>
      </Nav.Item>
      <Nav.Item>
        <Nav.Link onClick={() =>setStatus('Đã xác nhận')} style={{color: 'black', width:"214px"}} eventKey="link-3">Đã xác nhận</Nav.Link>
      </Nav.Item>
      <Nav.Item>
        <Nav.Link onClick={() => setStatus('Đã giao hàng')} style={{color: 'black', width:"214px"}} eventKey="link-4">Đã giao hàng</Nav.Link>
      </Nav.Item>
      <Nav.Item>
        <Nav.Link onClick={()=> setStatus('Huỷ đơn')} style={{color: 'black', width:"214px"}} eventKey="link-5">Đã huỷ</Nav.Link>
      </Nav.Item>
    </Nav>
        </div>
        <div className="order-search">
        <InputGroup className="mb-3">
        <InputGroup.Text id="basic-addon1"><BiSearchAlt size={26} /></InputGroup.Text>
        <Form.Control
